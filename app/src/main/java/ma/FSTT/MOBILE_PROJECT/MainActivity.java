package ma.FSTT.MOBILE_PROJECT;
...
import com.example.individualproject_currencyconverter.R;
...
//        edit_amount_to_convert_value = findViewById(R.id.edit_amount_to_convert_value);
        ...
        conversion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    Log.d("MainActivity2", "Button clicked");
    ...
    public void getConversionRate(String convert_from_value, String convert_to_value, Double edit_amount_to_convert_value) {
        RequestQueue requestqueue = Volley.newRequestQueue(this);
        String url = "https://api.currencyapi.com/v3/latest?apikey=cur_live_lp09i27GKBCsrRWuH9s2pycYyGILfYsl8Dk1gNKu&currencies=" + convert_to_value + "&base_currency=" + convert_from_value;
        Log.d("res4",url);
        ...
        StringRequest stringrequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e("MainActivity3", "Error while trying to get response from API", error);
            }
        });
